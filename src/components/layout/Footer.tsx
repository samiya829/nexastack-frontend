...
const socialLinks = [
  ...
  { icon: Mail, href: 'mailto:hello@nexastack.com', label: 'Email' },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs">
              The modern full-stack platform for building and deploying web applications at scale.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400 dark:text-gray-500">
            © {new Date().getFullYear()} NexaStack. All rights reserved.
          </p>
          <p className="text-sm text-gray-400 dark:text-gray-500">
